...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7e0b8d4f_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Vuer_vue__ = __webpack_require__(29);
...
/* scopeId */
var __vue_scopeId__ = "data-v-7e0b8d4f"
/* moduleIdentifier (server only) */
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7e0b8d4f_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Vuer_vue__["a" /* default */],
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1ac061ca_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__ = __webpack_require__(30);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-1ac061ca"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_App_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1ac061ca_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
var update = __webpack_require__(1)("38068a2f", content, true, {});
...
// module
exports.push([module.i, ".thumbnail[data-v-1ac061ca]{display:block;float:left;margin:3px;height:100px;width:100px;object-fit:cover}pre[data-v-1ac061ca]{font-family:Monaco;color:#fff;padding:.5rem}p[data-v-1ac061ca]{background:#4d4d4d}header[data-v-1ac061ca]{font-size:2rem;color:#fff}footer[data-v-1ac061ca]{font-size:1rem;color:#fff}.descript[data-v-1ac061ca]{font-size:1.3rem;color:#9a9a9a;margin-bottom:2rem}.subtitle[data-v-1ac061ca]{font-size:1.2rem;color:#a7a8aa;margin-bottom:1rem}.vue-green[data-v-1ac061ca]{color:#4fc08d}.iconfont[data-v-1ac061ca]{font-size:1.5rem;margin:.3rem}.gray[data-v-1ac061ca]{color:#ccc}", ""]);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("75fd433f", content, true, {});
...
// module
exports.push([module.i, ".prevent-pass-through[data-v-7e0b8d4f]{position:fixed;height:100%;width:100%;z-index:9;display:none}.prevent-pass-through-show[data-v-7e0b8d4f]{display:block}.words[data-v-7e0b8d4f]{position:absolute;text-align:center;font-size:12px;font-weight:700;font-stretch:normal;font-style:normal;line-height:normal;letter-spacing:-.15px;color:#2b3743}.index[data-v-7e0b8d4f]{bottom:20px;width:100%}.close-btn[data-v-7e0b8d4f]{top:16px;left:24px;padding:0;font-size:26px}.title[data-v-7e0b8d4f]{font-size:14px;font-weight:700;font-stretch:normal;font-style:normal;line-height:normal;letter-spacing:-.18px;text-align:center;color:#2b3743;top:27px;width:100%}.slider[data-v-7e0b8d4f]{position:fixed;top:100%;width:100%;left:0;height:100%;overflow:hidden;z-index:1000;opacity:0;-webkit-touch-callout:none;user-select:none}.item-wrapper[data-v-7e0b8d4f]{display:flex;justify-content:flex-start;height:100%}.item[data-v-7e0b8d4f]{height:100%;flex-basis:100%;flex-shrink:0}.z1[data-v-7e0b8d4f]{z-index:21}.open[data-v-7e0b8d4f]{animation:open-data-v-7e0b8d4f .3s;animation-fill-mode:forwards}@keyframes open-data-v-7e0b8d4f{0%{opacity:0;transform:translateY(0)}to{opacity:1;transform:translateY(-100%)}}.close[data-v-7e0b8d4f]{animation:close-data-v-7e0b8d4f .3s;animation-fill-mode:forwards}@keyframes close-data-v-7e0b8d4f{0%{opacity:1;transform:translateY(-100%)}to{opacity:0;transform:translateY(0)}}", ""]);
  ...
  install(Vue, options = {}) {
    ...
    let openVuer = (el, group) => e => {
      ...
      if (group || group === 0) {
        ...
        vm.desc = e.currentTarget.dataset.desc ? e.currentTarget.dataset.desc.split("*$") : [];
      } else {
        vm.isSingle = true;
        vm.imgList = [imgSrc];
        vm.isShow = true;
